...
public class BiAgent implements Agent {
    ...
    public String handle(String userMessage) {
        ...
        String systemPrompt = "你是一个精通 MySQL 数据库和 ECharts 可视化的资深数据分析师。\n" +
                ...
                "6. **JSON 输出格式**（仅在需要图表时）：\n" +
                "   必须在回复最后单独一行输出标准 JSON，格式如下：\n" +
                "   {\"type\":\"chart\",\"content\":{\"text\":\"文字说明\",\"data\":{\"chartType\":\"line/bar/pie\",\"title\":\"标题\",\"xAxis\":{\"label\":\"X轴标签\",\"data\":[...]},\"yAxis\":{\"label\":\"Y轴标签\",\"data\":[...]},\"series\":[{\"name\":\"系列名\",\"data\":[...]}],\"rawData\":[]}}}\n" +
